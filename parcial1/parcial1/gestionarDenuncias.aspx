...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:ListBox ID="denunciasLB" runat="server" DataSourceID="SqlDataSourceDenuncias" DataTextField="texto" DataValueField="id" Height="142px" Width="591px" AutoPostBack="True" OnSelectedIndexChanged="denunciasLB_SelectedIndexChanged"></asp:ListBox>
            <br />
...
&nbsp;<br />
            ...
            <br />
            <asp:DropDownList ID="categoriaDDL" runat="server" DataSourceID="SqlDataSourceCategorias" DataTextField="nombre" DataValueField="id" Height="16px" Width="332px">
            </asp:DropDownList>
            <br />
            <br />
        ...
        <asp:SqlDataSource ID="SqlDataSourceDenuncias" runat="server" ConnectionString="<%$ ConnectionStrings:IssdTP42023ConnectionString %>" DeleteCommand="DELETE FROM Denuncias WHERE (id = @idDenuncia)" InsertCommand="INSERT INTO Denuncias(idDenunciaCategoria, texto) VALUES (@idDenunciaCategoria, @texto)" SelectCommand="SELECT * FROM [Denuncias]" UpdateCommand="UPDATE Denuncias SET idDenunciaCategoria = @idDenunciaCategoria, texto = @texto WHERE (id = @idDenuncia)">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSourceDenunciasModificar" runat="server" ConnectionString="<%$ ConnectionStrings:IssdTP42023ConnectionString %>" SelectCommand="SELECT DenunciaCategorias.id, Denuncias.texto, DenunciaCategorias.nombre FROM Denuncias INNER JOIN DenunciaCategorias ON Denuncias.idDenunciaCategoria = DenunciaCategorias.id WHERE (Denuncias.id = @idDenuncia)">
            <SelectParameters>
                <asp:ControlParameter ControlID="denunciasLB" Name="idDenuncia" PropertyName="SelectedValue" />
            </SelectParameters>
        </asp:SqlDataSource>
